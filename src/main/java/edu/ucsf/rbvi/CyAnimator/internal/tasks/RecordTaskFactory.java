...
public class RecordTaskFactory extends AbstractTaskFactory {

	private CyServiceRegistrar registrar;
	private CyApplicationManager appManager = null;
	
	public RecordTaskFactory(CyServiceRegistrar registrar) {
		this.registrar = registrar;
	}
	
	public TaskIterator createTaskIterator() {
		appManager = registrar.getService(CyApplicationManager.class);
		return new TaskIterator(new RecordTask(registrar, appManager));
	}
